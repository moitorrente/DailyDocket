...
<div id="custom-menu">
  ...
  <a href="#" style="display: flex; align-items: center; gap: 15px;"><svg width="15" height="15" viewBox="0 0 15 15"
  ...
  <hr style="outline: none; border-color: #4b5563">
  <a href="#" style="display: flex; align-items: center; gap: 20px; padding-left: 15px;">
  ...
  <a href="#" style="display: flex; align-items: center; gap: 20px; padding-left: 15px;">
    ...
    this.shadowRoot.querySelectorAll('#custom-menu a').forEach((link, index) => {
      link.addEventListener('click', (event) => {
        ...
        if (index === 3) {
          changeTaskStatus(Number(this.lastTaskClicked.id), 'pending');
        }
        if (index === 4) {
          changeTaskStatus(Number(this.lastTaskClicked.id), 'stopped');
        }
        if (index === 5) {
          changeTaskStatus(Number(this.lastTaskClicked.id), 'progress');
        }
        if (index === 6) {
          changeTaskStatus(Number(this.lastTaskClicked.id), null);
        }
