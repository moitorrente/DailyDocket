  ...
  constructor() {
    ...
    this.shadowRoot.querySelectorAll('#custom-menu a').forEach((link, index) => {
      link.addEventListener('click', (event) => {
        ...
        if (index === 1) {
          copyTextToClipboard(getText(Number(this.lastTaskClicked.id)));
          const event = new CustomEvent('toast-message', {
