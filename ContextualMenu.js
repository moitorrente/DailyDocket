...
<div id="custom-menu" class="menu">
  <ul class="menu-list">
    <li class="menu-item">
      <button data-action="edit" class="menu-button">
    ...
    <li class="menu-item">
      <button data-action="due-date" class="menu-button">
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <li class="menu-item">
      <button data-action="copy" class="menu-button">
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
  ...
  <ul class="menu-list">
    <li class="menu-item">
      <button class="submenu menu-button menu-button--black">
      ...
      <ul class="menu-sub-list">
        <li class="menu-item">
          <button data-action="status" data-status="progress" class="menu-button menu-button--green">
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <li class="menu-item">
          <button data-action="status" data-status="pending"
        ...
        <li class="menu-item">
          <button data-action="status" data-status="planned" class="menu-button menu-button--blue">
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M9.875 7.5C9.875 8.81168 8.81168 9.875 7.5 9.875C6.18832 9.875 5.125 8.81168 5.125 7.5C5.125 6.18832 6.18832 5.125 7.5 5.125C8.81168 5.125 9.875 6.18832 9.875 7.5Z"
                fill="#2563eb">
        ...
        <li class="menu-item">
          <button data-action="status" data-status="stopped" class="menu-button menu-button--red">
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M9.875 7.5C9.875 8.81168 8.81168 9.875 7.5 9.875C6.18832 9.875 5.125 8.81168 5.125 7.5C5.125 6.18832 6.18832 5.125 7.5 5.125C8.81168 5.125 9.875 6.18832 9.875 7.5Z"
                fill="#ef4444">
        ...
        <li class="menu-item">
          <button data-action="status" data-status="null" class="menu-button menu-button--white menu-button--checked">
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M9.875 7.5C9.875 8.81168 8.81168 9.875 7.5 9.875C6.18832 9.875 5.125 8.81168 5.125 7.5C5.125 6.18832 6.18832 5.125 7.5 5.125C8.81168 5.125 9.875 6.18832 9.875 7.5Z"
                fill="#f9fafb">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub-list">
        <li class="menu-item">
          <button data-action="priority" data-priority="blocker" class="menu-button">
            <svg xmlns="http://www.w3.org/2000/svg" style="stroke: #facc15;" fill="none" viewBox="0 0 24 24"
        ...
        <li class="menu-item">
          <button data-action="priority" data-priority="high" class="menu-button">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-6 h-6">
              <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="menu-item">
          <button data-action="priority" data-priority="medium" class="menu-button">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-6 h-6">
        ...
        <li class="menu-item">
          <button data-action="priority" data-priority="low" class="menu-button">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-6 h-6">
              <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="menu-item">
          <button data-action="priority" data-priority="null"
  ...
  <ul class="menu-list">
    <li class="menu-item">
      <button data-action="delete" class="menu-button menu-button--delete">
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
